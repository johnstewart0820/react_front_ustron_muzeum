...
const ObjectInfo = (props) => {
  ...
  useEffect(() => {
    if (data.acf && data.acf.field_contact_hours) {
      const hourlist = get_contact_hours(data.acf.field_contact_hours);
      ...
      <div className="row">
        <div className="col-12 col-lg-5 mb-5">
          {current === "hours" ? (
            <>
              <h3>
                <small>{ data.acf && data.acf.field_contact_hours_title && data.acf.field_contact_hours_title }</small>
              </h3>
              {data.acf && data.acf.field_contact_price_description && <div className="object-info-description" dangerouslySetInnerHTML={{__html: data.acf.field_contact_hours_description}}></div>}
            </>
          ) : (
            <>
              <h3>
                <small>{ data.acf.field_contact_price_title }</small>
              </h3>
              {data.acf && data.acf.field_contact_price_description && <div className="object-info-description" dangerouslySetInnerHTML={{__html: data.acf.field_contact_price_description}}></div>}
            </>
          )}
        </div>
        <div className="col-lg-7">
          ...
          {current === "hours" ? (
            ...
            <div className="pricing mt-4">
              <div className="price-list-detail" dangerouslySetInnerHTML={{__html: data.acf.field_contact_price}}></div>
            </div>
          )}
        </div>
      </div>
